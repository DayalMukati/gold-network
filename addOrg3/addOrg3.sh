...
function printHelp () {
  ...
  echo "    -c <channel name> - test network channel name (defaults to \"goldchannel\")"
  ...
  echo "	addOrg3.sh up"
  echo "	addOrg3.sh up -c goldchannel -s couchdb"
...
#default for delay
CLI_DELAY=3
# channel name defaults to "goldchannel"
CHANNEL_NAME="goldchannel"
